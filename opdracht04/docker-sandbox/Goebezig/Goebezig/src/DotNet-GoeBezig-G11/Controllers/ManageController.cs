...
using DotNet_GoeBezig_G11.Models.ManageViewModels;
...
namespace DotNet_GoeBezig_G11.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        // GET: /Manage/Index
        [HttpGet]
        public async Task<IActionResult> Index(Cursist cursist, ManageMessageId? message = null)
        {
